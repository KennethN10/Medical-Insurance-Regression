...
3. Load the dataset by placing it in the project directory and running: data <- read.csv("insurance.csv")
4. Run the analysis script to generate visualizations and model outputs: source("analysis_script.R")
